...
parser.add_argument('-np', '--no-plot', help="no plot is shown.", action="store_false")         # graph show
parser.add_argument('-q', '--quiet', help="minimalistic console output.", action="store_false")
...
def score(args = args):
    ...
    for txt_file in ground_truth_files_list:
        ...
        if not os.path.exists(temp_path):
            ...
            error(error_msg)
        lines_list = file_lines_to_list(txt_file)   # read ground truth
        # create ground-truth dictionary
        bounding_boxes = []
        is_difficult = False
        already_seen_classes = []
        for line in lines_list:                                                             # ground truth
            try:

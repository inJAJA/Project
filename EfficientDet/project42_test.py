...
from efficientdet.project42dataset import Project42Dataset, Resizer, Normalizer, collater
...
model.load_state_dict(torch.load(f'/data/efdet/logs/{opt.project}/efficientdet-d{opt.compound_coef}_{opt.weights}.pth', map_location='cpu'))

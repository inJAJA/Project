...
from efficientdet.soccerdataset import SoccerDataset, Resizer, Normalizer, collater
from mAP.utils import mAP_score

parser = argparse.ArgumentParser()
parser.add_argument('-p', '--project', type=str, default='soccer_ball_data', help = 'project name')

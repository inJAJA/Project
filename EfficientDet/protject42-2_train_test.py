...
from efficientdet.project42dataset02 import Project42Dataset, Resizer, Normalizer, Augmenter, collater
...
def get_args():
    ...
    parser.add_argument('-p', '--project', type=str, default='task42_1130', help='project file that contains parameters')      # you need to change
    ...
    parser.add_argument('--log_path', type=str, default='/data/efdet/logs/')
...
def train(opt):
    ...
    training_set = Project42Dataset(root_dir=os.path.join(opt.data_path, params.project_name, 'crop'), set=params.train_set, params = params,

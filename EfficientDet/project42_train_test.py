...
from efficientdet.project42dataset import Project42Dataset, Resizer, Normalizer, Augmenter, collater
...
def get_args():
    ...
    parser.add_argument('-p', '--project', type=str, default='task42_1211', help='project file that contains parameters')   # you need to change
    ...
    parser.add_argument('--data_path', type=str, default='/data/data/ex_task42', help='the root folder of dataset')     # you need to change
    parser.add_argument('--log_path', type=str, default='/data/efdet/logs/')    # you need to change
    parser.add_argument('-w', '--load_weights', type=str, default='weights/efficientdet-d4.pth',
                        help='whether to load weights from a checkpoint, set None to initialize, set \'last\' to load last checkpoint')
    parser.add_argument('--saved_path', type=str, default='/data/efdet/logs/')
...
def train(opt):
    ...
    opt.saved_path = opt.saved_path + f'/{params.project_name}/weights/{save_time}'
        ...
        for epoch in range(opt.num_epochs):
            ...
            for iter, data in enumerate(progress_bar):
                ...
                try:
                    ...
                    #     img_show = cv2.rectangle(showshow, (a[0],a[1]), (a[2],a[3]), (255, 0, 0), 3)
